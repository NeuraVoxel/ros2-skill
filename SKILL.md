...
1. **[references/RULES.md](references/RULES.md) (CRITICAL):** Mandatory Agent Behaviour Rules (0-7), Safety Protocols, and Decision Frameworks. **Read this before performing any robot action.**
